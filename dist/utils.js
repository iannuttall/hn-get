...
export function toIsoFromUnix(seconds) {
...
export function parsePositiveInt(value, name, options = {}) {
...
export function parseNonNegativeInt(value, name, options = {}) {
    const parsed = Number.parseInt(String(value), 10);
    const max = options.max ?? Number.MAX_SAFE_INTEGER;
...
export function parseDateishToUnix(value, now = new Date()) {
